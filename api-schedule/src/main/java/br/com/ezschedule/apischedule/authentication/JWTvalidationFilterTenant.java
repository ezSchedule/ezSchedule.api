...
public class JWTvalidationFilterTenant extends BasicAuthenticationFilter {

    public static final String HEADER_ATTRIBUTE = "Authorization";
    public static final String PREFIX_ATTRIBUTE = "Bearer ";
    public JWTvalidationFilterTenant(AuthenticationManager authenticationManager) {
    ...
    private UsernamePasswordAuthenticationToken gePasswordAuthenticationToken(String token){
        String userTenant = JWT.require(Algorithm.HMAC512(JWTauthenticateFilterTenant.TOKEN_PASSWORD)).
                build().
                verify(token).
                getSubject();
        ...
        return new UsernamePasswordAuthenticationToken(userTenant, null, new ArrayList<>());
