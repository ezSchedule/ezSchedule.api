...
public class JsonResponse {
    ...
    public JsonResponse(String email, String cpf, String name, String residentsBlock, String block, Integer apartmentNumber, String phoneNumber, String number, boolean isAuthenticated, Boolean isAdmin) {
        this.email = email;
        this.cpf = cpf;
        this.name = name;
